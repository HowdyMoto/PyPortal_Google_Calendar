...
# Modified by Wright Bagwell
from adafruit_display_text.label import Label
from adafruit_bitmap_font import bitmap_font
from adafruit_oauth2 import OAuth2
from adafruit_pyportal import Network, Graphics

# Add a secrets.py to your filesystem that has a dictionary called secrets with "ssid" and "password" keys with your WiFi credentials. 
...
# Display user code and verification url NOTE: If you are displaying this on a screen, ensure the text label fields are long enough to handle the user_code and verification_url.
